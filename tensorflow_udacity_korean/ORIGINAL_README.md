...
리눅스에서는 http://127.0.0.1:8888 에 접속하세요.

맥에서는

    docker-machine ip default

를 사용해서 가상 머신의 IP를 찾아내신 뒤에 http://IP:8888 에 접속하세요. (보통 http://192.168.99.100:8888 입니다.)
